...
import wake from '../Assets/picoVoice/jarvis_android.ppn'
import context from '../Assets/picoVoice/alarm_android.rhn'
...
export default class App extends Component<Props, State> {
  readonly _accessKey =
    '6NTd3CjGFOc4pnmkXqgxLS41JxjGFyRAjxYHeOQbRDmeBQ5L6oOR2g==' // AccessKey obtained from Picovoice Console (https://console.picovoice.ai/)
  ...
  async componentDidMount() {
    let wakeWordPath = wake
    let contextPath = context
